...
const Earnings = () => {
    ...
    function processData(trips: any[], expenses: any[]) {
        ...
        if (grouping === 'day') {
            ...
            // If we don't have times, 'day' filter just shows one bar or we omit the chart.
            // Let's just show the last 7 days for 'day' and 'week' or something similar.
    ...
    const maxExpense = Math.max(...stats.chartData.map(d => d.expense), 1)
